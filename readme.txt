This is the repository for the Triangle Influence Maximization Project.

Triangle-O: OPIM-C-based algorithms
	OPIM: the original OPIM code
	HOPIM: HTriangleIM-O
	GOPIM: GTriangleIM-O
Triangle-S: D-SSA-based algorithms
	...
	HDSSA: HTriangleIM-S
	GDSSA: GTriangleIM-S
Triangle-Heu: Heuristic algorithms
...
3.  Run the corresponding executable file.
		...
		./OPIM -func=1 -gname=<dataset binary file> -alg=opim-c -mode=2 -seedsize=<the size of seed set> -eps=<epsilon,0.1> 
				-delta=<delta,1/n> -model=<IC or LT> -pdist=load -triangle=<the total number of triangle>  (For GTriangleIM, mode should be 0(vanilla) to avoid too small number of samples generated.)
...
4. Run the corresponding executable file.
        ...
        (Case study) ./verifyInf -i <dataset binary file> -o <seeds> -k <the size of seed set> -times <the number of samples to be generated> -nodescc <feature file of twitch-games>
